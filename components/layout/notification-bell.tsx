...
export function NotificationPanelContent({
  ...
  return (
    <div className="w-[360px] rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow-pop)]">
            ...
            {notifications.map((notification) => (
              <button
                ...
                className={cn(
                  ...
                  notification.read
                    ? "border-[var(--border)] bg-[var(--surface)] text-[var(--foreground)] hover:bg-[var(--muted)]/35"
                    : "border-transparent bg-[var(--primary-soft)] text-[var(--foreground)] hover:bg-[var(--primary-soft-strong)]"
                )}
              >
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        {localUnreadCount > 0 ? (
          <span className="absolute -right-1 -top-1 inline-flex min-w-5 items-center justify-center rounded-full bg-[var(--phase-canceled)] px-1.5 py-0.5 text-[10px] font-semibold text-white shadow-[var(--shadow-card)]">
            {unreadBadge}
          </span>
        ) : null}
      </Button>
