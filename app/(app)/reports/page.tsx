  ...
  return (
    <div className="space-y-6">
      ...
      <ExecutiveSavingsSummary
        commandCenterData={serializeDecimals(commandCenterData)}
        dashboardData={serializeDecimals(dashboardData)}
        loadState={{
          commandCenterError,
          dashboardError,
        }}
      />
      <ImportExportPanel readiness={serializeDecimals(workspaceReadiness)} />
    </div>
  );
}
